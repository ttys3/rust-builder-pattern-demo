...
impl OpenAIConfig {
    ...
    pub fn with_org_id<S: Into<String>>(&mut self, org_id: S) -> &mut Self {
        self.org_id = org_id.into();
        self
    }

    /// To use a different API key different from default OPENAI_API_KEY env var
    pub fn with_api_key<S: Into<String>>(&mut self, api_key: S) -> &mut Self {
        self.api_key = api_key.into();
        self
    }

    /// To use a API base url different from default [OPENAI_API_BASE]
    pub fn with_api_base<S: Into<String>>(&mut self, api_base: S) -> &mut Self {
